...
export function formatAttendance(attendance: AttendanceWithRelations): AttendanceResponseDto {
  return {
    id: attendance.id,
    present: attendance.present,
    date: attendance.date,
    student: attendance.student ? { id: attendance.student.id, name: attendance.student.name } : null,
