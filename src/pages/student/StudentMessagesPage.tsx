...
export default function StudentMessagesPage() {
  ...
  const [to, setTo] = useState(users.find((u) => u.role === 'teacher')?.id ?? '')
    ...
    <div className="space-y-6">
      <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Chat with teachers, admins, and your parents.</p>
        </div>
            ...
            {filtered.map((m) => (
              ...
              >
                <Avatar className="h-9 w-9">
                  <AvatarFallback className="bg-gradient-to-br from-violet-500 to-fuchsia-600 text-white text-xs">
